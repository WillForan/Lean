...
namespace QuantConnect.ToolBox.AlpacaDownloader
{
    /// <summary>
    /// Class for fetching stock historical price from Alpaca Finance
    /// </summary>
    public class Historical
    {
        /// <summary>
        /// Get stock historical price from Alpaca Finance
        /// </summary>
        ...
        /// <summary>
        /// Get raw stock historical price from Alpaca Finance
        /// </summary>
        /// <param name="symbol">Stock ticker symbol</param>
        /// <param name="start">Starting datetime</param>
        /// <param name="end">Ending datetime</param>
        ...
        public static string GetRaw(string symbol, DateTime start, DateTime end, string eventCode)
        {
            ...
            try
            {
                ...
                // TODO: update
                // raw url req? described here
                // https://alpaca.markets/docs/api-references/market-data-api/stock-pricing-data/historical/
                // or use "Web SDK"
                // https://github.com/alpacahq/alpaca-trade-api-csharp/wiki/Alpaca-REST-API
