...
{
    /// <summary>
    /// Alpaca Data Downloader class
    /// </summary>
    public class AlpacaDataDownloader : IDataDownloader
    {
        /// <summary>
        ...
        public IEnumerable<BaseData> Get(DataDownloaderGetParameters dataDownloaderGetParameters)
        {
            ...
            {
                throw new ArgumentException("The AlpacaDataDownloader hasn't been updated for non-daily.");
            }
